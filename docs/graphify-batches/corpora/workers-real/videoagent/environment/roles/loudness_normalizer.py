...
class LoudnessNormalizer(BaseTool):
    """
    Audio loudness normalization tool that commonly serve as audio preprocessing.
    ...
    class InputSchema(BaseTool.BaseInputSchema):
        data_dir: str = Field(
            ...,
            description="Directory of audio files to be normalized"
        )
    ...
    def execute(self, **kwargs):
        """
        Execute loudness normalization
        Parameter example:
        {
