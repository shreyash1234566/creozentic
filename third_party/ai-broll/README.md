...
- [MuAPI video playground](https://muapi.ai/playground) — Generate the image and video assets used in automated B-roll workflows.
- [MuAPI video-generation docs](https://muapi.ai/docs/video-generation) — API patterns for creating clips from prompts and source media.
